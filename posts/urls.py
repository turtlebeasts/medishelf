...
from .views import create_post, get_user_posts, delete_post, get_all_posts, search_medicines, get_medicine_detail
...
urlpatterns = [
    ...
    path("detail/<int:pk>/", get_medicine_detail, name="medicine_detail"),
]
